...
class WireframeIcons {
  ...
  getBasePath() {
    ...
    // From src/pages/X/ -> ../../wireframe/icons/
    if (path.includes('/src/pages/admin/')) {
      return '../../wireframe/icons/';
      ...
      return '../../wireframe/icons/';
    } else if (path.includes('/src/pages/sprint')) {
      // Generic fallback for future sprints (sprint4, sprint5, etc.)
      return '../../wireframe/icons/';
    } else if (path.includes('/src/components/')) {
      return '../wireframe/icons/';
    }
    return 'src/wireframe/icons/';
  }
